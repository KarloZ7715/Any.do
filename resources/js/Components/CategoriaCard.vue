...
<template>
    <div
        class="group relative bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md transition-all duration-200 hover:border-gray-300"
    >
        ...
        <div class="flex items-center gap-2 mt-4 pt-3 border-t border-gray-100">
            ...
            <Button
                variant="ghost"
                size="sm"
                class="flex-1 text-gray-600 hover:text-gray-900 hover:bg-gray-50"
